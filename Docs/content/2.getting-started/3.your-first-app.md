...
Continue with [views and view trees](/guides/foundations/views-and-view-trees), then [MVVM and binding](/guides/foundations/mvvm-and-binding) when you are ready to move the page state into a ViewModel.
