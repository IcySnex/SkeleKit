...
The badge and reselection properties belong to `ContentView`; [page chrome, search, and toolbars](/guides/application/page-chrome-search-and-toolbars) covers the rest of the page-owned shell configuration.
