---
title: Reusable views and controls
...
Use [authoring layout panels](/guides/advanced/authoring-layout-panels) when the component needs its own placement algorithm, or [native interop](/guides/advanced/native-interop) when it needs a UIKit host or controller.
