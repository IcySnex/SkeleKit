...
The service is available through the dependency-injection setup described in [application setup and dependency injection](/guides/application/application-builder-and-dependency-injection#services), or through `ContentView.SystemPicker`:
