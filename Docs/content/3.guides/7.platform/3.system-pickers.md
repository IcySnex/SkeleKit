...
The service is available through the dependency-injection setup described in [application setup and dependency injection](/guides/application/application-builder-and-dependency-injection#services), or through the protected `SystemPicker` property on any custom view:
