...
Setting these callbacks installs native recognizers without preventing child controls from receiving their own touches. `AddGesture` is available when a UIKit gesture recognizer is needed directly.
