...
Page registration and construction are covered separately in [page registration and lifetimes](/guides/application/page-registration-and-lifetimes).
...
Continue with [MVVM and binding](/guides/foundations/mvvm-and-binding) for one-way, two-way, converted, and list bindings.
