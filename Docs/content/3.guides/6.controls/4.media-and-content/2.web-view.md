...
Use [in-app Safari](/guides/application/modals-and-safari#in-app-safari) when the page should receive browser chrome, Reader support, and its own modal presentation.
