...
Use `Picker<TItem>` when the chosen value is application state. Use [`Button.Menu`](/guides/controls/actions-and-selection/button#menus) instead when every entry is an independent action.
