...
The editor exposes `ContentKind`, `Capitalization`, `Autocorrection`, nullable `GrammarChecking` (iOS 27), and `KeyboardLook`, plus font size, weight, and design. It does not provide a single-line return submission command because return inserts a new line.
