...
`CornerRadius` controls the size of the rounded corners. `CornerCurve` selects conventional circular corners or UIKit's smoother continuous shape. To match the current system inset-grouped list surface, use both values together:
