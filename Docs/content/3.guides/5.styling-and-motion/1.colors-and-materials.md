...
On a `ContentView`, `Background` fills the complete page beneath safe areas and translucent bars. `SafeAreaEdges` controls the page content's layout without clipping a color, gradient, or material assigned to the page itself.
