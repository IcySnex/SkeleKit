...
| Property | `SkeleKit.ScrollView.AvoidsKeyboard` | public/protected as emitted | implementation-defined; inspect source | No | n/a | Whether the content is inset so the keyboard never covers the focused control. |
