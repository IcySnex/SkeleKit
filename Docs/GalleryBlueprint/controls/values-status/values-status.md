...
| Property | `SkeleKit.Slider.Step` | public get/set | C# default | No | Visual/interaction only | The increment the value snaps to, or 0 for continuous. User changes are reported once per snapped value. |
