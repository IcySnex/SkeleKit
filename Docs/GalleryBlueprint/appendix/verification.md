...
| --- | ---: | ---: |
| XML documented baseline | 154 | 935 |
| Compiled accessible metadata (includes implementation-shaped/compiler-generated exports) | 155 | 1172 |
| Reconciled canonical tables | 155 | 1188 |
...
- Counted canonical API rows: **1,188**, matching the reconciled XML/metadata union used by these pages.
- Ran `dotnet test SkeleKit.Tests/SkeleKit.Tests.csproj -c Debug`: **174 passed**.
