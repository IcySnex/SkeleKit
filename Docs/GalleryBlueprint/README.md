...
- Compiled XML baseline: **155 documented types** and **945 documented declared members** (**1100 symbols total**).
- Reconciled compiled inventory: **156 accessible types** and **1203 declared fields/properties/events/constructors/methods** after metadata-only symbols are added.
