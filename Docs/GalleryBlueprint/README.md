...
- Compiled XML baseline: **154 documented types** and **935 documented declared members** (**1089 symbols total**).
- Reconciled compiled inventory: **155 accessible types** and **1188 declared fields/properties/events/constructors/methods** after metadata-only symbols are added.
