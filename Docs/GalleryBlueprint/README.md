...
- Compiled XML baseline: **154 documented types** and **928 documented declared members** (**1082 symbols total**).
- Reconciled compiled inventory: **155 accessible types** and **1185 declared fields/properties/events/constructors/methods** after metadata-only symbols are added.
