...
if "%WIN_ARCH%" equ "AMD64" (
    set JVM_TARGET_DIR=%BUILD_DIR%\jdk-25.0.3_windows-x64_bin\
    set JVM_URL=https://download.oracle.com/java/25/archive/jdk-25.0.3_windows-x64_bin.zip
) else if "%WIN_ARCH%" equ "ARM64" (
    set JVM_TARGET_DIR=%BUILD_DIR%\microsoft-jdk-25-windows-aarch64\
    set JVM_URL=https://aka.ms/download-jdk/microsoft-jdk-25-windows-aarch64.zip
) else (
