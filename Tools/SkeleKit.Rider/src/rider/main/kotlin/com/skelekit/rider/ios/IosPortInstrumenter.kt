...
// Installs a self-attached ByteBuddy agent and instruments IOSSessionHandler.preparePortsForDebugging.
// The concrete session handlers are final and off our classpath, but the port logic lives on this base
// method, so we patch it directly (by name). Retransformation covers the already-loaded case.
