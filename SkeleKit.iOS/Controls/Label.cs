...
public class Label : Control
{
	...
	{
		get => weight is SkeleKit.FontWeight.Bold;
		set => boldBinding = Register(boldBinding, value, value => Set(ref weight, value ? SkeleKit.FontWeight.Bold : SkeleKit.FontWeight.Regular, ApplyFont));
	}
