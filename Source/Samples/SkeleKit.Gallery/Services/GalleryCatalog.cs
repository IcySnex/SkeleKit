	...
	public GalleryCatalog()
	{
		...
		[
			...
			Section(
				...
				Topic("Item Templates", "Strongly typed reusable cells for heterogeneous data.", "rectangle.3.group", Colors.Teal, GalleryArea.Framework, typeof(ItemTemplatesViewModel)),
				...
				Topic("Sections", "Headers, footers and mixed section layouts.", "list.bullet.rectangle", Colors.Teal, GalleryArea.Framework, typeof(SectionsViewModel)),
				Topic("Collection Interactions", "Refresh, swipe actions, context menus and reordering.", "hand.draw.fill", Colors.Teal, GalleryArea.Framework, typeof(CollectionInteractionsViewModel))),
			...
			Section(
				...
				Topic("Animation", "Curves, springs, layout transitions and interactive animators.", "waveform.path", Colors.Cyan, GalleryArea.Framework, typeof(AnimationViewModel)))
		];
